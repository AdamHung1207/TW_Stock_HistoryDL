嗨！我是Adam Hung，是一名大學關於程式都是高分通過，但畢業了之後走錯路，變成了硬體工程師，直到現在仍然對程式很有興趣，但是很懶得從頭學起的MIS/IT。

所以透過了用ChatGPT、Grok3、DeepSeek等AI工具打造自己要的程式。

目前來到第一個了。

在GitHub上找了一輪，從證交所抓資料要超久的欸 .. 如果只是要股價的話。
